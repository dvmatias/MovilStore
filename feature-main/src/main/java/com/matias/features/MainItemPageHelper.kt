...
class MainItemPageHelper(context: Context) {
	...
	private var labelList: Array<String> = context.resources.getStringArray(R.array.styling_bottom_nav_labels)

	var tagList: List<Features> = listOf(Features.TAB_HOME, Features.TAB_PRODUCTS, Features.TAB_SHOP_CART, Features.TAB_CONTACT_US, Features.TAB_PROFILE)
	...
	private var iconList: IntArray = intArrayOf(
